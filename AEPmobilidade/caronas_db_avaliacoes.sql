...
CREATE TABLE `avaliacoes` (
  ...
  PRIMARY KEY (`id`),
  KEY `carona_id` (`carona_id`),
  KEY `avaliador_id` (`avaliador_id`),
  CONSTRAINT `avaliacoes_ibfk_1` FOREIGN KEY (`carona_id`) REFERENCES `caronas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `avaliacoes_ibfk_2` FOREIGN KEY (`avaliador_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
